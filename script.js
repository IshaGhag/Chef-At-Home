...
const singleItemInfo = food => {
    ...
    <ul class="ingredient-list">
        <li class = "ingredient-list-item"><i class="far fa-hand-point-right food-icons"></i> ${food.strMeasure1} - ${food.strIngredient1}</li>
        <li class = "ingredient-list-item"><i class="far fa-hand-point-right food-icons"></i> ${food.strMeasure2} - ${food.strIngredient2}</li>
        <li class = "ingredient-list-item"><i class="far fa-hand-point-right food-icons"></i> ${food.strMeasure3} - ${food.strIngredient3}</li>
        <li class = "ingredient-list-item"><i class="far fa-hand-point-right food-icons"></i> ${food.strMeasure4} - ${food.strIngredient4}</li>
        <li class = "ingredient-list-item"><i class="far fa-hand-point-right food-icons"></i> ${food.strMeasure5} - ${food.strIngredient5}</li>
        <li class = "ingredient-list-item"><i class="far fa-hand-point-right food-icons"></i> ${food.strMeasure6} - ${food.strIngredient6}</li>
        <li class = "ingredient-list-item"><i class="far fa-hand-point-right food-icons"></i> ${food.strMeasure7} - ${food.strIngredient7}</li>
        <li class = "ingredient-list-item"><i class="far fa-hand-point-right food-icons"></i> ${food.strMeasure8} - ${food.strIngredient8}</li>
    </ul>
